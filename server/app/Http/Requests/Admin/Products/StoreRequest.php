...
class StoreRequest extends FormRequest
{
    ...
    {
        return [
            'name.required' => 'Mục họ tên là bắt buộc. Vui lòng nhập lại.',
            'name.unique' => 'Họ tên không được trùng nhau. Vui lòng nhập lại.',
            'price.required' => 'Mục giá cả là bắt buộc. Vui lòng nhập lại.',
            'price.numeric' => 'Mục giá cả phải là kiểu số. Vui lòng nhập lại.',
            'description.required' => 'Mục description là bắt buộc. Vui lòng nhập lại.',
            ...
            'feature.required' => 'Mục featured là bắt buộc. Vui lòng nhập lại.',
