...
const DesignerList = () => {
  ...
  // Get data products
  useEffect(() => {
    fetch('http://127.0.0.1:8000/api/designers', {
      method: "GET",
      headers: {
      ...
      .then((data) => {
        ...
        setCollectionsList(data.designers);
      })
  ...
  const handleEditItem = (idDesigner) => {
    // navigate
    navigate('/dashboard/designer/edit/' + idDesigner);
  }
  ...
  return (
    <Box m="20px">
      <Header
        title="LIST DESIGNERS"
        subtitle="List of Designers for Future Reference"
      />
      <Box
        m="40px 0 0 0"
        height="75vh"
