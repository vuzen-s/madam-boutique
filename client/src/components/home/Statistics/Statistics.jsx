                    ...
                    <div className="p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="stats" role="tabpanel"
                        ...
                        <dl className="grid max-w-screen-xl grid-cols-2 gap-8 p-4 mx-auto text-gray-900 sm:grid-cols-3 xl:grid-cols-6 dark:text-white sm:p-8">
                            <div className="flex flex-col items-center justify-center">
                                <dt style={{color: 'black'}} className="mb-2 text-3xl font-extrabold">3M+</dt>
                                <dd className="text-gray-500 dark:text-gray-400">Developers</dd>
                            </div>
                            <div className="flex flex-col items-center justify-center">
                                <dt style={{color: 'black'}} className="mb-2 text-3xl font-extrabold">10M+</dt>
                                <dd className="text-gray-500 dark:text-gray-400">Public repositories</dd>
                            </div>
                            <div className="flex flex-col items-center justify-center">
                                <dt style={{color: 'black'}} className="mb-2 text-3xl font-extrabold">100s</dt>
                            ...
                            <div className="flex flex-col items-center justify-center">
                                <dt style={{color: 'black'}} className="mb-2 text-3xl font-extrabold">20+</dt>
                                <dd className="text-gray-500 dark:text-gray-400">Top Forbes companies</dd>
                            </div>
                            <div className="flex flex-col items-center justify-center">
                                <dt style={{color: 'black'}} className="mb-2 text-3xl font-extrabold">2M+</dt>
